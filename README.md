...
Based on below tests and tried with different themes, the best option would be SVG, only in Dark theme it's not visible and in Dimmed it's not that readable. So maybe better is still the PNG black on white version although is not scalable it's good enough when you zoom in.
...
### PNG version (better quality than GIF):  
...
### SVG version (resolution independent / difficult to see with Dark and Dimmed theme):  
...
## Black on White version (works with Default Black/White/Dimmed themes used on e.g. Github and StackOverflow)  
### GIF version(lower quality):  
...
### SVG version (resolution independent, but does not support black on white?!):  
![equation](http://latex.codecogs.com/svg.latex?%5Cbg_white%20O_t%3D%5Ctext%20%7B%20Onset%20event%20at%20time%20bin%20%7D%20t)  
![equation](http://latex.codecogs.com/svg.latex?%5Cbg_white%20s%3D%5Ctext%20%7B%20sensor%20reading%20%7D)  
![equation](http://latex.codecogs.com/svg.latex?%5Cbg_white%20P%28s%20%7C%20O_t%20%29%3D%5Ctext%20%7B%20Probability%20of%20a%20sensor%20reading%20value%20when%20sleep%20onset%20is%20observed%20at%20a%20time%20bin%20%7D%20t)  
